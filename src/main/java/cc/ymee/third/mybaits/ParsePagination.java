...
public class ParsePagination {
    ...
    public ParsePagination() {
        ...
        String cookiePageSize = cookieMap.get("ps");
        String cookiePage = cookieMap.get("pn");

        HttpSession session = request.getSession();

        String sessionPage = (String) session.getAttribute("pn");
        String sessionPageSize = (String) session.getAttribute("ps");
